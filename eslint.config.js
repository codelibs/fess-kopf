...
module.exports = [
  ...
  // The Vue app under app/. Separate from the AngularJS blocks above because
  // it is ES modules and TypeScript; the two trees coexist until the
  // migration's final switch-over removes src/ and this block's neighbours.
  //
  ...
  // Scoped with files: some entries in these plugin configs carry no files
  // key of their own, and an unscoped entry would impose sourceType
  // 'module' on src/kopf, which is ecmaVersion 5 script.
